...
type CloudMenu struct {
	...
	MenuPath   string `json:"menu_path" gorm:"size:255;not null;default:'';comment:菜单路径"`
	...
	Permission string `json:"permission" gorm:"size:255;not null;default:'';comment:菜单权限标识"`
	ParentId   uint32 `json:"parent_id" gorm:"index;not null;default:0;comment:父级ID"`
	Component  string `json:"component" gorm:"size:255;not null;default:'';comment:菜单组件"`
